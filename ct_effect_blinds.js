...
;(function() {
	...
	function _blinds(params, callback) {
		...
		s.innerHTML = ".ct-blinds-blade{position:absolute;width:" + dw + "px;height:" + dh + "px;" + css["transform-style"] + ":preserve-3d;" + css.transition + ":transform " + duration + "ms ease;" + css.transform + ":perspective(" + perspective + "px) translate3d(0,0,-" + dc + "px)}"
